 ...
 */
@Local
public interface SegPermisoServicioLocal {

    public String crearPermiso(SegPermiso segRol) throws Exception;

    public String editarPermiso(SegPermiso segRol) throws Exception;

    public String eliminarPermiso(SegPermiso segRol) throws Exception;
