...
public class InicioCapturaEnemdu2107 {

    // <editor-fold defaultstate="collapsed" desc=" ATRIBUTOS-PROPIEDADES ">
    private static final Logger LOGGER = Logger.getLogger(InicioCapturaEnemdu2107.class.getName());
 ...
 /*CAMPOS PARA PARAMETROS PARA ACTUALIZAR INFORMACIÓN*/
    private Integer paramIdOpeEstAc;
    private List<AdmOperacionEstadistica> listaOpeEstAc;
    private final String BUSQ_OPEESTAc = "codMueDet.codMuestra.codOpeEst.idOpeEst";
    private Integer paramIdPeriodoAc;
    private List<AdmPeriodo> listaPeriodoAc;
    private final String BUSQ_PERIODOAc = "codMueDet.codMuestra.codPeriodo.idPeriodo";

    private Integer paramIdOperativoAc;
    private List<MetOperativo> listaOperativoPorOpeEstyPeriodoAc;
    private final String BUSQ_OPERATIVOAc = "codFormulario.codOperativo.idOperativo";

    private Integer paramIdFormularioAc;
    private List<MetFormulario> listaFormulariosPorOperativoAc;
    private final String BUSQ_FORMULARIOAc = "codFormulario.idFormulario";

    private String paramTipoAc;
    private List<SelectItem> listaTiposAc;
    private final String BUSQ_TIPOAc = "tipo";

    private String paramZonalAc;
    private List<SelectItem> listaZonalAc;
    private final String BUSQ_ZONALAc = "zonal";

    private final String BUSQ_CLAVEAc = "clave";

    private final String BUSQ_CONTROL1Ac = "control1";

    private final String BUSQ_CONTROL2Ac = "control2";

    private Map<String, Object> parametrosCargaPendienteAc;
    private Map<String, Object> parametrosCabecerasCreadasAc;

    private List<SelectItem> listaResultadoEntrevistaAc;
    private List<CaptCargaControlEquipo> listaCargaControlEquipoAc;
    private List<CaptCargaControl> listaCargaPendienteAc;
    private List<CaptCargaControl> listaFormulariosPorHogar;
    private List<CaptCabecera> listaFormulariosCreadosAc;
     ...
     */
    public InicioCapturaEnemdu2107() {
    }
    // </editor-fold>
    ...
    public void inicializarParametrosActualizar() {
        paramIdOpeEstAc = null;
        paramIdPeriodoAc = null;
        paramIdOperativoAc = null;
        paramIdFormularioAc = null;
        paramTipoAc = null;
        paramZonalAc = null;
        parametrosCargaPendienteAc = new HashMap<String, Object>();
        parametrosCabecerasCreadasAc = new HashMap<String, Object>();
...
//                listaFormulariosCreados = bc.getCaptCabeceraServicioRemote().listarCabecerasPorParametros(parametros);
    ...
    private void buscarCabecerasCreadas() {
        try {
            ...
            Map<String, Object> parametros = new HashMap<String, Object>();
            if (uc.usuarioTieneRol("ROL_VALID") || uc.usuarioTieneRol("COOR_TEC_NAC") || uc.usuarioTieneRol("RES_ZON") || uc.usuarioTieneRol("ROL_OBS") || uc.usuarioTieneRol("ROL_RESP_CRIT")) {//OJO ANALIZAR VISTA DE REGISTROS PARA VALIDADOR
                parametros.put("clave", conglomeradoSelected);
                parametros.put("estadoLogico", true);
                parametros.put("codCarCon.codFormulario.codificacion", "ENEMDU_2107");
                listaFormulariosCreados = bc.getCaptCabeceraServicioRemote().listarCabecerasPorParametros(parametros);
            } else {
                // cambio vic 21/05/2020
//                parametros.put("clave", conglomeradoSelected);
...
//                listaFormulariosCreados = bc.getCaptCabeceraServicioRemote().listarCabecerasPorParametros(parametros);
    ...
    public void buscarInformacion() {
        try {
            if (uc.usuarioTieneRol("ROL_VALID") || uc.usuarioTieneRol("COOR_TEC_NAC") || uc.usuarioTieneRol("RES_ZON") || uc.usuarioTieneRol("ROL_OBS") || uc.usuarioTieneRol("ROL_RESP_CRIT")) {
    ...
    public void cargarListasIniciales() {
        try {
            listaOpeEstAc = bc.getAdmOperacionEstadisticaServicioRemote().listarTodosActivos();
    ...
    public void editarFormulario(CaptCabecera cab) {
        try {
            ...
            if (uc.usuarioTieneRol("ROL_ENCUE") && (cabeceraActual.getEstado().equals("VC") || cabeceraActual.getEstado().equals("VS"))) {
                ...
                bc.addErrorMessage("El formulario ya ha sido criticado !No puede acceder!");
            } else if (uc.usuarioTieneRol("ROL_SUPER") && (cabeceraActual.getEstado().equals("G") || cabeceraActual.getEstado().equals("00"))) {
                bc.addErrorMessage("El formulario aun no ha sido validado !No puede acceder!");
//            } else if ((uc.usuarioTieneRol("ROL_REVIS") || uc.usuarioTieneRol("ROL_VALID")) && (cabeceraActual.getEstado().equals("G") || cabeceraActual.getEstado().equals("00") || cabeceraActual.getEstado().equals("VG"))) {
//                bc.addErrorMessage("El formulario aun no ha sido supervisado !No puede acceder!"); //Se modifica D.A 30072020 (Revisor tambien ingresa boletas)
            } else {
    ...
    public void eliminaCargaControl(CaptCargaControl cc) {
        try {
            ...
            Logger.getLogger(InicioCapturaEnemdu2107.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void eliminaCabecera(CaptCabecera c) {
        try {
            if (c != null) {
                ...
                if ((uc.usuarioTieneRol("ROL_ENCUE") || uc.usuarioTieneRol("ROL_SUPER") || uc.usuarioTieneRol("ROL_REVIS")) && cabeceraActual.getEstado().equals("VC")) {
                    bc.addErrorMessage("El formulario ya ha sido criticado !No puede eliminar!");
                } else {
...
//    public void crearFormularioEfectivo() {dar
//        try {
//
...
//    }
    ...
    public void crearHogar() {
        System.out.println("Ingresacreación de hogar");
        try {
    ...
    public void actualizaCabecaeraEnemCovid() {
        try {
            ...
            Logger.getLogger(InicioCapturaEnemdu2107.class
...
//hg                cabeceraActual.setCodMuestra(cargaActual.getCodMueDet());
    ...
    public Integer getParamIdOpeEstAc() {
        return paramIdOpeEstAc;
    }

    public void setParamIdOpeEstAc(Integer paramIdOpeEstAc) {
        this.paramIdOpeEstAc = paramIdOpeEstAc;
    }

    public List<AdmOperacionEstadistica> getListaOpeEstAc() {
        return listaOpeEstAc;
    }

    public void setListaOpeEstAc(List<AdmOperacionEstadistica> listaOpeEstAc) {
        this.listaOpeEstAc = listaOpeEstAc;
    }

    public Integer getParamIdPeriodoAc() {
        return paramIdPeriodoAc;
    }

    public void setParamIdPeriodoAc(Integer paramIdPeriodoAc) {
        this.paramIdPeriodoAc = paramIdPeriodoAc;
    }

    public List<AdmPeriodo> getListaPeriodoAc() {
        return listaPeriodoAc;
    }

    public void setListaPeriodoAc(List<AdmPeriodo> listaPeriodoAc) {
        this.listaPeriodoAc = listaPeriodoAc;
    }

    public Integer getParamIdOperativoAc() {
        return paramIdOperativoAc;
    }

    public void setParamIdOperativoAc(Integer paramIdOperativoAc) {
        this.paramIdOperativoAc = paramIdOperativoAc;
    }

    public List<MetOperativo> getListaOperativoPorOpeEstyPeriodoAc() {
        return listaOperativoPorOpeEstyPeriodoAc;
    }

    public void setListaOperativoPorOpeEstyPeriodoAc(List<MetOperativo> listaOperativoPorOpeEstyPeriodoAc) {
        this.listaOperativoPorOpeEstyPeriodoAc = listaOperativoPorOpeEstyPeriodoAc;
    }

    public Integer getParamIdFormularioAc() {
        return paramIdFormularioAc;
    }

    public void setParamIdFormularioAc(Integer paramIdFormularioAc) {
        this.paramIdFormularioAc = paramIdFormularioAc;
    }

    public List<MetFormulario> getListaFormulariosPorOperativoAc() {
        return listaFormulariosPorOperativoAc;
    }

    public void setListaFormulariosPorOperativoAc(List<MetFormulario> listaFormulariosPorOperativoAc) {
        this.listaFormulariosPorOperativoAc = listaFormulariosPorOperativoAc;
    }

    public String getParamTipoAc() {
        return paramTipoAc;
    }

    public void setParamTipoAc(String paramTipoAc) {
        this.paramTipoAc = paramTipoAc;
    }

    public List<SelectItem> getListaTiposAc() {
        return listaTiposAc;
    }

    public void setListaTiposAc(List<SelectItem> listaTiposAc) {
        this.listaTiposAc = listaTiposAc;
    }

    public String getParamZonalAc() {
        return paramZonalAc;
    }

    public void setParamZonalAc(String paramZonalAc) {
        this.paramZonalAc = paramZonalAc;
    }

    public List<SelectItem> getListaZonalAc() {
        return listaZonalAc;
    }

    public void setListaZonalAc(List<SelectItem> listaZonalAc) {
        this.listaZonalAc = listaZonalAc;
    }

    public List<SelectItem> getListaResultadoEntrevistaAc() {
        return listaResultadoEntrevistaAc;
    }

    public void setListaResultadoEntrevistaAc(List<SelectItem> listaResultadoEntrevistaAc) {
        this.listaResultadoEntrevistaAc = listaResultadoEntrevistaAc;
    }

    public List<CaptCargaControlEquipo> getListaCargaControlEquipoAc() {
        return listaCargaControlEquipoAc;
    }

    public void setListaCargaControlEquipoAc(List<CaptCargaControlEquipo> listaCargaControlEquipoAc) {
        this.listaCargaControlEquipoAc = listaCargaControlEquipoAc;
    }

    public List<CaptCargaControl> getListaCargaPendienteAc() {
        return listaCargaPendienteAc;
    }

    public void setListaCargaPendienteAc(List<CaptCargaControl> listaCargaPendienteAc) {
        this.listaCargaPendienteAc = listaCargaPendienteAc;
    }
    ...
    public List<CaptCabecera> getListaFormulariosCreadosAc() {
        return listaFormulariosCreadosAc;
    }

    public void setListaFormulariosCreadosAc(List<CaptCabecera> listaFormulariosCreadosAc) {
        this.listaFormulariosCreadosAc = listaFormulariosCreadosAc;
    }
