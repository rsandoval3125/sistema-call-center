...
@ManagedBean
@ViewScoped
public class InicioCapturaPublicoSiacControlador {

    // <editor-fold defaultstate="collapsed" desc=" ATRIBUTOS-PROPIEDADES ">
    private static final Logger LOGGER = Logger.getLogger(InicioCapturaPublicoSiacControlador.class.getName());
    ...
    private List<MetCatalogo> listaPregFrecDenuncia;
    private String PRIVATE_CAPTCHA_KEY;
    private String PUBLIC_CAPTCHA_KEY;
  ...
  //</editor-fold>
     ...
     */
    public InicioCapturaPublicoSiacControlador() {
    }
...
// </editor-fold>
    ...
    public void inicializar() {
        try {
            ...
            listaPregFrecDenuncia = new ArrayList<>();
            credencialesCaptcha();
    ...
    public void credencialesCaptcha(){
        try {
             PRIVATE_CAPTCHA_KEY = bc.getAdmParametroGlobalServicioRemote().buscarXNombre("PRIVATE_CAPTCHA_KEY").getValor();
             PUBLIC_CAPTCHA_KEY = bc.getAdmParametroGlobalServicioRemote().buscarXNombre("PUBLIC_CAPTCHA_KEY").getValor();
        } catch (Exception e) {
        }
    }
    ...
    public void cargarListasIniciales() {
        try {
            ...
            listaPregFrecDenuncia =  bc.getMetCatalogoServicioRemote().listarCatalogoXAlias("CAT_PREG_FREC_DENUNCIA");
    ...
    public void irAFormularioInquietudes(){
        try {
            String url = "/sipe-captura-siac-war/formularios/publico/formularioPublicoInquietudes.xhtml";
             bc.redirect(url);
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//    public void irPaginaExterna(){
//        try {
//            String url = bc.getAdmParametroGlobalServicioRemote().buscarXNombre("CENSO-ECUADOR").getValor();
//            bc.redirect(url);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
...
//    }
    ...
    public void irAFormularioNoCensado(){
        try {
             MetCatalogo actividad = new MetCatalogo();
             actividad = bc.getMetCatalogoServicioRemote().buscarCatalogoXAlias("SIAC_TIPO_ACTIVIDAD_03");
             System.out.println("actividad  "+actividad.getAlias());
             if(actividad != null && actividad.getEstadoLogico()){
                String url = "/sipe-captura-siac-war/formularios/publico/formularioPublicoNoCensado.xhtml";
                bc.redirect(url);
             }else{
                 FacesContext.getCurrentInstance().addMessage(null, new FacesMessage("SERVICIO NO DISPONIBLE POR EL MOMENTO"));   
             }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void irAFormularioDenuncias(){
        try {
            String url = "/sipe-captura-siac-war/formularios/publico/formularioPublicoDenuncias.xhtml";
             bc.redirect(url);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    public void irAFormularioCensoEnLinea(){
        try {
             String url = "/sipe-captura-siac-war/formularios/publico/formularioPublicoCensoEnLinea.xhtml";
             bc.redirect(url);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void irAFormularioInicio(){
        try {
               String url = "/sipe-captura-siac-war/paginas/captura/inicioCapturaPublico.xhtml";
               bc.redirect(url);
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//                    String url = "/sipe-captura-siac-war/formularios/inquietudes.xhtml";
                    String url = "/sipe-captura-siac-war/formularios/inquietudes/listaInquietudes.xhtml";
                    bc.redirect(url);
                } catch (Exception ex) {
                    LOGGER.log(Level.SEVERE, null, ex);
                }
            ...
            case 02:
                try {
                    ...
                    String url = "/sipe-captura-siac-war/formularios/denuncias.xhtml";
                    bc.redirect(url);
                } catch (Exception ex) {
                    LOGGER.log(Level.SEVERE, null, ex);
                }
...
//                    String url = "/sipe-captura-siac-war/formularios/registroNoCensados.xhtml";
                    String url = "/sipe-captura-siac-war/formularios/noCensado/listaNoCensado.xhtml";
                    bc.redirect(url);
                } catch (Exception ex) {
                    LOGGER.log(Level.SEVERE, null, ex);
                }
            ...
            case 04:
                try {
                    ...
                    String url = "/sipe-captura-siac-war/formularios/FPRUEBA_F1_2022.xhtml";
                    bc.redirect(url);
                } catch (Exception ex) {
                    LOGGER.log(Level.SEVERE, null, ex);
                }
...
// <editor-fold defaultstate="collapsed" desc=" GETTERSYSETTERS ">
    ...
    public String getPRIVATE_CAPTCHA_KEY() {
        return PRIVATE_CAPTCHA_KEY;
    }

    public void setPRIVATE_CAPTCHA_KEY(String PRIVATE_CAPTCHA_KEY) {
        this.PRIVATE_CAPTCHA_KEY = PRIVATE_CAPTCHA_KEY;
    }

    public String getPUBLIC_CAPTCHA_KEY() {
        return PUBLIC_CAPTCHA_KEY;
    }

    public void setPUBLIC_CAPTCHA_KEY(String PUBLIC_CAPTCHA_KEY) {
        this.PUBLIC_CAPTCHA_KEY = PUBLIC_CAPTCHA_KEY;
    }
    
     public List<MetCatalogo> getListaPregFrecDenuncia() {
        return listaPregFrecDenuncia;
    }

    public void setListaPregFrecDenuncia(List<MetCatalogo> listaPregFrecDenuncia) {
        this.listaPregFrecDenuncia = listaPregFrecDenuncia;
    }
