 ...
 * <br/><h:inputHidden  id="saltos" value="#{saltoValidacionControlador.listarSaltos(ensanutF1Controlador.cabeceraActual.codCarCon.codFormulario.idFormulario)}" />
 * <br/><h:inputHidden  id="validaciones" value="#{saltoValidacionControlador.listarValiadciones(ensanutF1Controlador.cabeceraActual.codCarCon.codFormulario.idFormulario)}" />
 * 
 */
@ManagedBean
@ViewScoped
