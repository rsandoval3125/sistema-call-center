...
@ManagedBean
@ViewScoped
public class InicioCapturaSiacControlador {

    // <editor-fold defaultstate="collapsed" desc=" ATRIBUTOS-PROPIEDADES ">
    private static final Logger LOGGER = Logger.getLogger(InicioCapturaSiacControlador.class.getName());
  ...
  //</editor-fold>
     ...
     */
    public InicioCapturaSiacControlador() {
    }
...
// </editor-fold>
    ...
    //                    bc.addSuccessMessage("usted ingreso a Denuncias");
                        String url = "/sipe-captura-siac-war/formularios/denuncias/listaDenuncias.xhtml";
                        bc.redirect(url);
                    } catch (Exception ex) {
                        LOGGER.log(Level.SEVERE, null, ex);
                    }
    ...
    //                    String url = "/sipe-captura-siac-war/formularios/registroNoCensados.xhtml";
                ...
                case 04:
                    try {
                        ...
                        String url = "/sipe-captura-siac-war/formularios/censoenlinea/listaCensoEnLinea.xhtml";
                        bc.redirect(url);
                    } catch (Exception ex) {
                        LOGGER.log(Level.SEVERE, null, ex);
                    }
                 ...
                 case 05:
                    try {
                        ...
                        String url = "/sipe-captura-siac-war/formularios/asignaciones/listaAsignaciones.xhtml";
                        bc.redirect(url);
                    } catch (Exception ex) {
                        LOGGER.log(Level.SEVERE, null, ex);
                    }
