...
@ManagedBean
@ViewScoped
public class InicioCapturaSiacF1 {

    // <editor-fold defaultstate="collapsed" desc=" ATRIBUTOS-PROPIEDADES ">
    private static final Logger LOGGER = Logger.getLogger(InicioCapturaSiacF1.class.getName());
    ...
    private String dpaProvinciaSelect;
    private List<MetCatalogo> listaDPAProv;
    private String dpaCantonSelect;
    private List<MetCatalogo> listaDPACant;
    private String dpaParroqioaSelect;
    private List<MetCatalogo> listaDPAParr;

    // <editor-fold defaultstate="collapsed" desc=" CONSTRUCTOR ">
    /**
     * Creates a new instance of GeneracionFormulario
     */
    public InicioCapturaSiacF1() {
    }
...
// </editor-fold>
    ...
    public void inicializar() {
        try {
            listaDPAProv = new ArrayList<>();
            listaDPACant = new ArrayList<>();
            listaDPAParr = new ArrayList<>();
    ...
    public void inicializarParametrosBusqueda() {
        try {
            dpaProvinciaSelect = null;
            dpaCantonSelect = null;
            dpaParroqioaSelect = null;
    ...
    public void cargarListasIniciales() {
        try {
            listaDPAProv = bc.getMetCatalogoServicioRemote().listarCatalogoXAlias("CAT_DPA_PROV");
            listaDPACant = bc.getMetCatalogoServicioRemote().listarCatalogoXAlias("CAT_DPA_CANTON");
            listaDPAParr = bc.getMetCatalogoServicioRemote().listarCatalogoXAlias("CAT_DPA_PARR");
        } catch (Exception ex) {
            LOGGER.log(Level.SEVERE, null, ex);
        }
    }
