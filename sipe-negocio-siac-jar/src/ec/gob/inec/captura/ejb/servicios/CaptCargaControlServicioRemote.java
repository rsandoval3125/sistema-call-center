 ...
 */
@Remote
public interface CaptCargaControlServicioRemote {
    ...
    public CaptCargaControl obtenerCargaControlPorClave2020(String idCarCon, String codFormulario) throws Exception;
