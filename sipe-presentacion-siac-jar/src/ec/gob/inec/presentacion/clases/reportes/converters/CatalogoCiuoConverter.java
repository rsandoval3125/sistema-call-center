 ...
 * @author rmoreano
 */
@FacesConverter("catalogoCiuoConverter")
public class CatalogoCiuoConverter implements Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
        if (!value.equals("null") && value.trim().length() > 0) {
            try {
                return new MetCatalogoCiuo(Integer.valueOf(value));
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object object) {
        if (object != null && object != "") {
            return String.valueOf(((MetCatalogoCiuo) object).getIdCatalogoCiuo());
