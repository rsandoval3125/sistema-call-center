 ...
 * @since 0.7.0
 */
public class PDFExporterCarto extends Exporter {
        ...
        try {
            ...
            while (st.hasMoreElements()) {
                ...
                if (!lstFor2.isEmpty()) {
                    ...
                    tableZonal.setTotalWidth(450);
                    tableZonal.setLockedWidth(true);
                    tableZonal.setWidths(new float[]{9, 27, 3, 9, 17});
                    ...
                    cellZonal = new PdfPCell(new Paragraph("Clave", boldFor2));
                    cellZonal.setHorizontalAlignment(Element.ALIGN_LEFT);
                    cellZonal.setVerticalAlignment(Element.ALIGN_MIDDLE);
                    tableZonal.addCell(cellZonal);

                    cellZonal = new PdfPCell(new Paragraph(clave, normalFor2));
                    cellZonal.setHorizontalAlignment(Element.ALIGN_LEFT);
                    cellZonal.setVerticalAlignment(Element.ALIGN_MIDDLE);
                    tableZonal.addCell(cellZonal);
                    ...
                    cellT3 = new PdfPCell(new Paragraph("OTROS", boldFor2));
                    cellT3.setHorizontalAlignment(Element.ALIGN_CENTER);
                    cellT3.setVerticalAlignment(Element.ALIGN_MIDDLE);
                    table3.addCell(cellT3);

                    cellT3 = new PdfPCell(new Paragraph("1= Edif. sin Viv.\n"
                            + "2= Sin Edificación", normalFor2));
                    cellT3.setHorizontalAlignment(Element.ALIGN_JUSTIFIED);
                    cellT3.setVerticalAlignment(Element.ALIGN_MIDDLE);
                    table3.addCell(cellT3);

                    thirdTableCell.addElement(table3);
                    ...
                    if (clave != null) {
                        if (!clave.isEmpty()) {
                            ...
                            table1.setTotalWidth(350);
                            table1.setLockedWidth(true);
                            table1.setWidths(new float[]{9, 17});

                            PdfPCell cell1 = new PdfPCell(new Paragraph("Clave", boldFor2));
                            cell1.setHorizontalAlignment(Element.ALIGN_LEFT);
                            cell1.setVerticalAlignment(Element.ALIGN_MIDDLE);
                            table1.addCell(cell1);

                            cell1 = new PdfPCell(new Paragraph(clave, normalFor2));
                            cell1.setHorizontalAlignment(Element.ALIGN_LEFT);
                            cell1.setVerticalAlignment(Element.ALIGN_MIDDLE);
                            table1.addCell(cell1);
    ...
    public PdfPTable tablaFor2(int indexLstFor2NoIncremental, int indexLstFor2, List<Object[]> lstFor2, List<Object[]> resumenFiltro, List<Object[]> resumenFiltroFor2, Font boldFor2, Font normalFor2, PdfPCell cell, PdfPTable table) {
        ...
        if (!resumenFiltro.isEmpty()) {
            ...
            /*if (clave.substring(6, 9).equals("999")) {
                ...
                indexLstFor2NoIncremental = indexLstFor2NoIncremental+1;
                indexLstFor2 = indexLstFor2+1;
            }*/
